...
fedkit makes a different bet: **radical simplicity on platform primitives**.
...
fedkit's shared surface is **explicit and inspectable**. You declare what's shared; the CLI
...
- **Use fedkit** if you want a small, standards-native primitive you can read in an afternoon,
